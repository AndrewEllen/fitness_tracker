...
class EnterConfirmationPage extends StatefulWidget {
  EnterConfirmationPage({Key? key, required this.videoController})
      : super(key: key);
    ...
    if (FirebaseAuth.instance.currentUser!.phoneNumber != null) {
      if (context.mounted) {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                UserSetupCaloriesPage(videoController: widget.videoController),
          ),
        );
      }
    }
                              ...
                              children: <Widget>[
                                ...
                                Center(
                                  child: ElevatedButton(
                                    ...
                                    child: const Text(
                                        'Send SMS Code'), // Text displayed on the button
                                  ),
                                ),
                                const SizedBox(height: 20.0),
                                _sendSMS
                                    ? Text(
                                        ...
                                        style:
                                            boldTextStyle.copyWith(fontSize: 18),
                                      )
                                    : const SizedBox.shrink(),
                                _sendSMS
                                    ? const SizedBox(height: 8)
                                    : const SizedBox
                                        .shrink(), // Adds vertical spacing
                                _sendSMS
                                    ? Text(
                                ...
                                _sendSMS
                                    ? Center(
                                        child: ElevatedButton(
                                          onPressed: () =>
                                              addPhoneToAccount(context),
                                          child: const Text(
                                              'Confirm Code'), // Text displayed on the button
                                        ),
                                      )
                                    : const SizedBox.shrink(),
                                SizedBox(height: _sendSMS ? 10.h : 60.h),
                                Center(
                                  child: TextButton(
